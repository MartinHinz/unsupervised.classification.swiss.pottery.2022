...
> Hinz, M., Heitz, C., (2022). _`r Title`_. Name of journal/book <https://doi.org/xxx/xxx>

Our pre-print is online here:

> Hinz, M., Heitz, C., (2022). _`r Title`_. Name of journal/book, Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://doi.org/xxx/xxx>
...
__Do not use this dummy data for real research analysis!!!__
...
The __analysis__ directory contains:
  ...
  - [:file\_folder: data](/analysis/data): Data used in the analysis. For this pre-release, this folder contains __Dummy data!!!__
...
__Text, Code and figures :__  [CC-BY-4.0](http://creativecommons.org/licenses/by/4.0/)

__Data :__ [CC-0](http://creativecommons.org/publicdomain/zero/1.0/) attribution requested in reuse
